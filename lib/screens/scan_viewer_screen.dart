    ...
    return Scaffold(
                ...
                child: ClipRRect(
                  ...
                  child: GestureDetector(
                    ...
                    onLongPressStart: PlatformHelper.isDesktop
                        ? null
                        : (details) => _viewController.showContextMenu(context, details.globalPosition, index, widget.scanDir),
                    child: Image.file(
                      _viewController.images[index],
                      key: ValueKey(_viewController.images[index].lastModifiedSync().millisecondsSinceEpoch),
                      fit: BoxFit.contain,
                    ),
                  ),
                ),
      ...
      bottomNavigationBar: BottomAppBar(
        child: Row(
          ...
          children: [
            InkWell(
              onTap: PlatformHelper.isDesktop ? null : () => _viewController.showAddMorePagesDialog(context, widget.scanDir),
              child: Column(
            ...
            InkWell(
              onTap: () => _viewController.showExportOptions(context, widget.scanDir),
              child: Column(
                mainAxisSize: MainAxisSize.min,
                children: [
            ...
            InkWell(
              onTap: PlatformHelper.isDesktop ? null : () => _viewController.renameScan(context, widget.scanDir),
              child: Column(
                mainAxisSize: MainAxisSize.min,
                children: [
                  Icon(
